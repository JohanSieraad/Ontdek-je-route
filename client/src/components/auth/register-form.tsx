...
export function RegisterForm({ onSwitchToLogin, onClose }: RegisterFormProps) {
  ...
  const onSubmit = async (data: RegisterData) => {
    try {
      ...
      setError(err instanceof Error ? err.message : "Er ging iets mis bij de registratie");
    }
  };
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <p className="text-gray-600">Start met het maken van je eigen routes</p>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Social Registration Buttons - Placeholder for now */}
        <div className="space-y-2">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-gray-500">Of registreer met</span>
            </div>
          </div>
